# -*- coding: utf-8 -*-
"""Copia de customers_and_orders.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1GqJ1xoQS0pH7G9ZQVwM-quraY5hkeSsz
...
# Let us drop the rows that are repeated in the "states" columm and the length on this table would be how many different states there are.
